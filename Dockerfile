# Code heavily based on jrottenberg/ffmpeg:4.2-nvidia and jrottenberg/ffmpeg:4.2-vaapi:
  # https://github.com/jrottenberg/ffmpeg/blob/master/docker-images/4.2/vaapi/Dockerfile
  # https://github.com/jrottenberg/ffmpeg/blob/master/docker-images/4.2/nvidia/Dockerfile
# Authors of original code: Julien Rotterberg, Phil Michell and 
# Original ffmpeg docker code is under an Apache 2.0 license.

# Additions and changes were made by: Oscar Andersson (github.com/oscarA1994)

# Changes to ffmpeg docker code:
# The ffmpeg build is mainly based on the jrottenberg/nvidia dockerfile but has code
# from the jrottenberg/vaapi docker file which enables vaapi.

# Addition: Setup for the MOGA-encode optimisation algorithm is included at the end of this file.
